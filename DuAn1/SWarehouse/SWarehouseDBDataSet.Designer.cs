...
namespace SWarehouse {
    ...
    public partial class SWarehouseDBDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/SWarehouseDBDataSet.xsd";
        ...
        public partial class STAFFSDataTable : global::System.Data.TypedTableBase<STAFFSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public STAFFSRow AddSTAFFSRow(string Name, string Address, string Phone, string Email, decimal Salary, string Image, bool Status) {
        ...
        public partial class STAFFSRow : global::System.Data.DataRow {
            ...
            public string Image {
                get {
                    try {
                        return ((string)(this[this.tableSTAFFS.ImageColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace SWarehouse.SWarehouseDBDataSetTableAdapters {
    ...
    public partial class STAFFSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[STAFFS] WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ([Email] = @Original_Email) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[STAFFS] ([Name], [Address], [Phone], [Email], [Salary], [Image], [Status]) VALUES (@Name, @Address, @Phone, @Email, @Salary, @Image, @Status);
SELECT ID, Name, Address, Phone, Email, Salary, Image, Status FROM STAFFS WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[STAFFS] SET [Name] = @Name, [Address] = @Address, [Phone] = @Phone, [Email] = @Email, [Salary] = @Salary, [Image] = @Image, [Status] = @Status WHERE (([ID] = @Original_ID) AND ([Name] = @Original_Name) AND ([Address] = @Original_Address) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ([Email] = @Original_Email) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)) AND ((@IsNull_Image = 1 AND [Image] IS NULL) OR ([Image] = @Original_Image)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT ID, Name, Address, Phone, Email, Salary, Image, Status FROM STAFFS WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, Name, Address, Phone, Email, Salary, Image, Status FROM dbo.STAFFS";
        ...
        public virtual int Fill(SWarehouseDBDataSet.STAFFSDataTable dataTable) {
        ...
        public virtual SWarehouseDBDataSet.STAFFSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SWarehouseDBDataSet.STAFFSDataTable dataTable = new SWarehouseDBDataSet.STAFFSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SWarehouseDBDataSet.STAFFSDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SWarehouseDBDataSet dataSet) {
        ...
        public virtual int Delete(int Original_ID, string Original_Name, string Original_Address, string Original_Phone, string Original_Email, global::System.Nullable<decimal> Original_Salary, string Original_Image, global::System.Nullable<bool> Original_Status) {
        ...
        public virtual int Insert(string Name, string Address, string Phone, string Email, global::System.Nullable<decimal> Salary, string Image, global::System.Nullable<bool> Status) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Address, string Phone, string Email, global::System.Nullable<decimal> Salary, string Image, global::System.Nullable<bool> Status, int Original_ID, string Original_Name, string Original_Address, string Original_Phone, string Original_Email, global::System.Nullable<decimal> Original_Salary, string Original_Image, global::System.Nullable<bool> Original_Status) {
            return this.Update(Name, Address, Phone, Email, Salary, Image, Status, Original_ID, Original_Name, Original_Address, Original_Phone, Original_Email, Original_Salary, Original_Image, Original_Status, Original_ID);
        }
    }
